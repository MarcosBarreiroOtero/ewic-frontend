...
public class Reservation implements Serializable {
	...
	private static final long serialVersionUID = 3684457303425814709L;
	...
	public Reservation(int idReservation, Calendar date, String state, String remarks, int nClients,
			String idGoogleLoginClient, int idShop, String clientName) {
